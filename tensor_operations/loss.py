import torch
import tensor_operations.vision as ovis
import tensor_operations.differentiation as odiff
import tensor_operations.warp as owarp
...
def calc_consistency_oflow_epe2d_loss(oflow_pred, oflow_gt, mask_valid):
    loss_epe = torch.norm((oflow_pred - oflow_gt) * mask_valid, dim=1, p=2).mean()
    return loss_epe
